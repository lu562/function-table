...
_sage_const_8 = Integer(8); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)
import time
start = time.time()
#basic param
#n = 64
...
F2 = Integers(_sage_const_2 **_sage_const_8 )
#F2 = Integers(2)
F3 = Integers(_sage_const_2 **_sage_const_8 )
#F3 = Integers(3)
...
for i in range(k-_sage_const_1 ):
	for j in range(_sage_const_2 **l):
		a = F3.random_element()
		sofsoft_1[_sage_const_0 ][i][j] = a
		sofsoft_2[_sage_const_0 ][i][j] = F3(int(sofsoft[_sage_const_0 ][i][j])) - a
		a = F3.random_element()
		sofsoft_1[_sage_const_1 ][i][j] = a
		sofsoft_2[_sage_const_1 ][i][j] = F3(int(sofsoft[_sage_const_1 ][i][j])) - a
